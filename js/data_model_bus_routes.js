...
//2016
//bus routes - part of data model 
//class to present bus routes data in a way required by other portions of the application 
//========================================================================================

var BusRoutes = function(bus_routes_data, bus_stops, data_model) {
    //constructor takes bus route data as generated from Excel files
    //, list of bus stops as generated from Excel files, 
    //and builds two  main data structures: 
    //1. by_number - array of bus route numbers
    //2. list of bus routes, aligned with the by_number array.
    //That is, if by_number[0] is "180",
    //then list[0] will contain stops for route 180
    this.list = Array();
    this.by_number = {};
